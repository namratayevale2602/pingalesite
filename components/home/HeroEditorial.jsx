...
const SLIDES = [
  {
    ...
    headline: "Your goals deserve",
    accent: "a real plan,",
    subline: "not just a product.",
    body: "Most advisors hand you a brochure. We hand you a written plan — one that covers investments, insurance, taxes, and legacy together. One plan. One advisor. For life.",
  ...
  },
  {
    ...
    tag: "SIP & Mutual Funds",
    headline: "₹10,000 a month",
    accent: "becomes ₹1 Crore",
    subline: "in 15 years. Automatically.",
    body: "No timing the market. No guessing. Just a systematic plan — right funds, right allocation, automatic step-up every year. We set it up in one meeting.",
  ...
  },
  {
    ...
    tag: "Life & Health Insurance",
    headline: "If something happened",
    accent: "to you tomorrow,",
    subline: "is your family covered?",
    body: "A ₹1 Crore term plan costs about ₹900 a month for a 30-year-old. We compare 14 insurers, handle the paperwork, and stay with your family through any claim.",
  ...
  },
  {
    ...
    headline: "At 60, you should",
    accent: "choose to work,",
    subline: "not be forced to.",
    body: "The gap between a comfortable retirement and a stressful one is usually one decision made 20 years earlier. We help you make that decision — then stay accountable to it.",
