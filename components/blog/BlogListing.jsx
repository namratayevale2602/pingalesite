        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 gap-12 mb-16 lg:grid-cols-[1.4fr_1fr]">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="text-[var(--fg-muted)] text-sm mb-6">{featured.d}</div>
              <Link href={`/blog/${featured.slug}`} className="btn btn-secondary self-start">Read blog →</Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {filtered.map((p, i) => (
              <article key={i} className="flex flex-col gap-4 pb-6 border-b border-[var(--rule)]">
                ...
                <div className="text-[var(--fg-muted)] text-[13px]">{p.d}</div>
                <Link
                  href={`/blog/${p.slug}`}
