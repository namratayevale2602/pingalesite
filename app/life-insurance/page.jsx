...
export const metadata = buildMetadata("life");
...
const BENEFITS_WITH_ICONS = KEY_BENEFITS.map(benefit => {
  const IconComponent = Icons[benefit.icon];
  return { ...benefit, icon: IconComponent ? <IconComponent /> : null };
});
...
const serviceSchema = getServiceSchema(pageSEO.life, "life");

export default function LifePage() {
  return (
    <SeoWrapper pageUrl="/life-insurance" schemas={[breadcrumb, serviceSchema]}>
      <main>
          ...
          <div className="container">
            <div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-2 lg:gap-20">
              ...
              <div className="relative">
                <img
                  src="/services/healthinsurance.webp"
        ...
        <section className="section">
          <div className="container">
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {BENEFITS_WITH_ICONS.map((b, i) => (
                <Reveal key={i} delay={i * 60}>
                  <div className="p-7 bg-[var(--bg-elev)] border border-[var(--rule)] rounded-2xl h-full">
                    <div className="text-[36px] mb-4 text-[var(--brand-2)]">{b.icon}</div>
