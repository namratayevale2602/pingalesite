...
export const metadata = {
  title: "General Insurance — Pingale Financial Services",
};
...
export default function GeneralPage() {
  return (
    <main>
      {/* <PageHero
        eyebrow="General Insurance · IRDAI-licensed broker · Health, motor, travel, home"
        title={<>Cover for everything <span className="italic-serif">except life.</span></>}
        intro="Health, motor, travel, home, personal accident and commercial cover — brokered across 20+ insurers. We are IRDAI-licensed and do not represent any single insurer."
        ...
        <div className="container">
          <div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-2 lg:gap-20">
            ...
            <div className="relative">
              <img
                src="/services/genralinsurances.jpg"
