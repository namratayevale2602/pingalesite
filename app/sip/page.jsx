...
export const metadata = {
  title: "Mutual Funds & SIP — Pingale Financial Services",
};
...
export default function SIPPage() {
  return (
    <main>
      {/* <PageHero
        eyebrow="Mutual Funds & SIP · AMFI-registered distributor · ARN-XXXXXX"
        title={<>Systematic wealth, <span className="italic-serif">goal by goal.</span></>}
        intro="SIP, lumpsum, ELSS, debt, liquid and index funds across 38 AMCs — all under one written financial plan. We are AMFI-registered mutual fund distributors."
      ...
      <section className="section bg-[var(--paper-2)] border-t border-b border-[var(--rule)]">
        <div className="container">
          ...
          {/* Highlighted statutory disclaimer */}
          <div
        ...
        <div className="container">
          <StickyLead title="Start your SIP today">
            ...
            >
              ...
              possible loss of principal. Pingale Financial Services · AMFI Reg. No. ARN-XXXXXX · Valid through 31-Oct-2027 ·
